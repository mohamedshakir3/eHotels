...
export default function RoomOverview({
	...
	const description = `The ${room.HotelName} is a ${
		room.Category
	} star hotel located in ${room.City}, ${room.Country}. It has a capacity of ${
		room.Capacity
	} people and has a beautiful ${room.View.toLocaleLowerCase()}.`;
						...
						<form className="mt-10" action={validateBooking}>
							...
							<div className="mt-4">
								{issues.length > 0 && (
									<>
										...
										<div className="flex items-center space-x-3">
											{issues.map((issue) => (
												<Badge key={issue.IssueID} color="red">
								...
								<div className="mt-4">
									...
									<div className="flex items-center space-x-3">
										<Badge color="indigo">{room.View}</Badge>
									</div>
								</div>
								{/* 
								<RadioGroup
					...
					<div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
						...
						<div className="mt-10">
							...
							<div className="mt-4 space-y-6">
								<p className="text-sm text-gray-600">{`${room.Street}, ${room.City}, ${room.PostalCode}, ${room.Country}`}</p>
							</div>
						</div>
					</div>
				</div>
